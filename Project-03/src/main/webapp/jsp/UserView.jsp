...
.m{
	background-image:
		url('<%=ORSView.APP_CONTEXT%>/img/pexels-olia-danilevich-5088008.jpg');
	background-size: 100%;
	padding-top: fixed;
}
					...
					<div class="card">
						<div class="card-body">
							...
							<div>
								...
								<%-- <%
									if (id > 0 && dto.getPassword()!=null) {
								%>
								<input type="hidden" name="password"
									value="<%=dto.getPassword()%>"> <input type="hidden"
									name="confirmPassword" value="<%=dto.getConfirmPassword()%>">
								<%
									}
								%> --%>
							</div>
